...
#+BEGIN_SRC elisp
  ...
  (defun org-get-next-matching-entry-pair (pattern)
    "Return (CONTENTS . BEGINNING-POSITION) for the next entry that matches PATTERN."
  ...
  (defun org-get-matching-entries (pattern)
    ...
    (org-with-wide-buffer
     ...
     (helm-org-rifle-accumulate 'org-get-next-matching-entry-pair pattern)))
